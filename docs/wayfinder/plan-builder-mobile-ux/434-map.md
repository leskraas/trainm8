...
Tracked as [#434](https://github.com/leskraas/trainm8/issues/434). That issue is the map;
this document is the reasoning behind it. Child issues are filed after the owner's cut.

**Status: awaiting the owner's cut. No code written.**
