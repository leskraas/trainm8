...
function UpcomingTrainingHeader() {
	return (
		<Card className="mb-6">
			<CardContent className="grid gap-6 sm:grid-cols-[1fr_auto] sm:items-end">
				<div>
			...
			<CardFooter className="border-border/70 bg-muted/35 -mb-5 flex-wrap gap-2 border-t py-3">
...
function UpcomingLedgerSummaryPanel({
	...
	return (
		<Card aria-labelledby="upcoming-ledger-summary" className="mb-5 gap-0 py-0">
			<CardContent className="grid gap-0 px-0 md:grid-cols-[1fr_1.25fr_1fr]">
...
function LoadOverlay({
	...
	return (
		<Card aria-labelledby="load-overlay-title" className="mb-5 gap-0 py-0">
