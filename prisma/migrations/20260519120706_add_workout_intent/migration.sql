...
INSERT INTO "new_Workout" ("discipline", "createdAt", "description", "id", "intent", "ownerId", "title", "updatedAt") SELECT "discipline", "createdAt", "description", "id", 'endurance', "ownerId", "title", "updatedAt" FROM "Workout";
DROP TABLE "Workout";
