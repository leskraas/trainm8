...
async function seed() {
	...
	await prisma.workout.create({
		data: {
			...
			description: '45-minute tempo session with structured warm-up and cool-down.',
			activityType: 'run',
			ownerId: kody.id,
			blocks: {
				create: [
					{
						...
						steps: {
							create: [
								{ description: '10 min easy jog', activity: 'run', intensity: 'easy', orderIndex: 0 },
								{ description: '4 × 100m strides', activity: 'run', intensity: 'threshold', orderIndex: 1 },
							],
						},
					},
					{
						...
						steps: {
							create: [
								{ description: '20 min at tempo pace (zone 4)', activity: 'run', intensity: 'threshold', orderIndex: 0 },
								{ description: '2 min walk recovery', activity: 'rest', intensity: 'easy', orderIndex: 1 },
								{ description: '10 min at tempo pace (zone 4)', activity: 'run', intensity: 'threshold', orderIndex: 2 },
							],
						},
					},
					{
